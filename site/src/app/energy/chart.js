...
export const POW = {
  ...
  sys2: {tl:'所属中心', data:['电子中心','机电中心','管理平台','生产公用']},
...
export const optBar = (data) => {
  ...
  const mapData = (d) => [
    d.sys1[0], d.sys1[1], d.sys1[2],
    d.sys2[0], d.sys2[1], d.sys2[2], d.sys2[3],
    d.sys3[0], d.sys3[1], d.sys3[2], d.sys3[3],
  ];
    ...
    series: [
      {
        ...
        data: mapData(data).map((value, index) => {
          const colors = [
            '#FF0000', '#FF3333', '#FF6666', // 红色系
            '#00FF00', '#33FF33', '#66FF66', '#99FF99', // 绿色系
            '#0000FF', '#3333FF', '#6666FF', '#9999FF'  // 蓝色系
          ];
          return {
            y: value,
