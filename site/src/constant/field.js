const unitList = { chcp:'kw',chcpa:'kw',el:'kwh',ela:'kwh',fl:'m3/h',fla:'m3',fr:'hz',hcp:'kw',hcpa:'kw',li:'m',po:'kw',poa:'kw',pr:'kpa',pri:'bar',pro:'bar',son:'',tp:'℃',vlp:'%',vls:'',wfl:`m3/h`,wfla:`m3/h`,wpri:'kpa',wpro:'kpa',wtpi:'℃',wtpo:'℃',yc:'m',rlap:'%',al:'', vlpf:'', vlpc: '', rem: '',sdal: '',eer_o:'',acp_po:'kw',acp_el:'kwh',vlp:'%',  cnt:'%',sfb:'%',pos:'%',fac:'%',cod:'%',avg:'%',l3:'%',l2:'%',l1:'%',ac:'%',bc:'%',ab:'%',prd:'%',src:'%',rst:'%',tp1:'℃', tp2:'℃', tp3:'℃'
}
